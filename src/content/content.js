(() => {
    // const console = window.console.context ? window.console.context('opensourcein') : window.console;
    const console = { log: () => {}, error: () => {} }; // Disable logging
    console.log('Content script loaded');

    function getLocation() {
        return window.openSourceInTest ? window.openSourceInTest.location : window.location;
    }

    function getChrome() {
        return window.openSourceInTest ? window.openSourceInTest.chrome : window.chrome;
    }
